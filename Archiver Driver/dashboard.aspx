...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [name], [password], [email] FROM [client]" DeleteCommand="DELETE FROM [client] WHERE [email] = @email" InsertCommand="INSERT INTO [client] ([name], [password], [email]) VALUES (@name, @password, @email)" UpdateCommand="UPDATE [client] SET [name] = @name, [password] = @password WHERE [email] = @email">
        <DeleteParameters>
    ...
    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="email" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" Width="894px" HorizontalAlign="Justify">
